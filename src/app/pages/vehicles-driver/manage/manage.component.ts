...
export class ManageComponent implements OnInit {
  ...
  constructor(
    ...
    private vehiclesService: VehiclesDriverService,
  ...
  createForDriver() {
          ...
          this.vehiclesService.createForDriver(this.driver_id, this.vehicledriver).subscribe((data) => {
            ...
            this.router.navigate(["VehiclesDriver/filterByDriver", this.driver_id]);
          });
        }
        createForVehicle() {
          this.vehicledriver.vehicle_id = this.vehicle_id;
          ...
          this.vehiclesService.createForVehicle(this.vehicle_id, this.vehicledriver).subscribe((data) => {
            ...
            this.router.navigate(["VehiclesDriver/filterByVehicle", this.vehicle_id]);
          });
        }
  update() {
    if (this.theFormGroup.invalid) {
